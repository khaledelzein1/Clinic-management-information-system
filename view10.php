        ...
        <tr align="right"> 
          <td colspan="2" height="9"> 
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="40">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="editreferal.php"><b>BACK</b></a></font></td> 
			   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
			   
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>UPDATE REFERRAL INFORMATIONS</b>
                 </font></td>
...
<?php /*         VIEW.PHP        Displays all data from 'players' table*/        // connect to the database     
 include"bdd.php";       
  // get results from database   
       $result = mysql_query("select * from clinic.referal where  referal.patientid = '".$_POST["medicalnumber"]."' and referal.referaldate= '".$_POST["orderdate"]."'")   or die(mysql_error());       
	                      // display data in table       
						        
						             echo "<table  bgcolor='white' border='1' cellpadding='10'>";       
									  echo "<tr><th>ID</th><th>MR</th> <th>DOCTOR NAME</th><th>FINANCIAL CATEGORY</th><th>DIAGNOSIS</th><th>TO HOSPITAL</th><th>REFERRAL DATE</th><th>DR.NOTES</th><th>EDIT </th><th>DELETE</th> </tr>";     
										          ...
										          echo "<tr>";      
												            echo '<td>' . $row['referalid'] . '</td>';       
															         echo '<td>' . $row['patientid'] . '</td>';       
																			  ...
																			  echo '<td><center>' . $row['financial'] . '</td>';   
																			  echo '<td><center>' . $row['diagnosis'] . '</td>';   
																			  echo '<td><center>' . $row['tohospital'] . '</td>';  
																			  echo '<td>' . $row['referaldate'] . '</td>';  
																			    echo '<td>' . $row['notes'] . '</td>';
																			           echo '<td><a href="edit10.php?referalid=' . $row['referalid'] . '"><u>Edit</u></a></td>';          
																					         echo '<td><a href="delete10.php?referalid=' . $row['referalid'] . '"><u>Delete</u></a></td>';                                                                                      echo "</tr>";         }       
												    // close table>       
													 echo "</table>";?><p><a href="referal.php">Add a new record</a></p></body></html> 