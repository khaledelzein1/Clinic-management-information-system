  ...
  <tr>
    <td align="center">
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr> <br>
		<img border="0" src="images/lab.jpg" width="1300" height="130">
        ...
        <tr align="right"> 
          <td colspan="2" height="9"> 
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="40">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="editlabres.php"><b>BACK</b></a></font></td> 
...
<html><head>        <title>CMIS</title></head>
<body>
<?php /*         VIEW.PHP        Displays all data from 'players' table*/        // connect to the database     
 include"bdd.php";       
  // get results from database   
       $result = mysql_query("select labresult.labresultid,labresult.laboratoryid,labresult.labresultdate,labresult.labresult,labresult.notes from labresult where labresult.laboratoryid='".$_POST["ordernumber"]."' and labresult.labresultdate = '".$_POST["orderdate"]."' ")   or die(mysql_error());       
	                      // display data in table       
						        
						             echo "<table  bgcolor='white' border='1' cellpadding='10'>";       
									  echo "<tr><th>LAB TEST ID</th> <th> RESULT DATE</th> <th>LAB RESULT</th><th>DOCTOR NOTES</th><th>EDIT </th><th>DELETE</th> </tr>";     
						      // loop through results of database query, displaying them in the table    
							      while($row = mysql_fetch_array( $result )) {                         
								         // echo out the contents of each row into a table       
										          echo "<tr>";      
												             
															 echo '<td><center>' . $row['laboratoryid'] . '</td>';     
															         echo '<td>' . $row['labresultdate'] . '</td>';       
																	          echo '<td><center>' . $row['labresult'] . '</td>';       
																			  echo '<td><center>' . $row['notes'] . '</td>';   
																			   
																			  
																			           echo '<td><a href="edit4.php?labresultid=' . $row['labresultid'] . '"><u>Edit</u></a></td>';          
																					         echo '<td><a href="delete4.php?labresultid=' . $row['labresultid'] . '"><u>Delete</u></a></td>';                                                                                      echo "</tr>";         }       
												    // close table>       
													 echo "</table>";?><p><a href="lab1.php">Add a new results</a></p></body></html> 