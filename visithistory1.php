...
?>
        <tr valign="top"> 
          <td colspan="3" height="18"> 
                  ...
                  <div class="imagebox">
<form  action="visithistory1.php" id="todayapp1" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
 <br><br><br><br>
<center><table background="images/log2.jpg">
<tr>
<TD align="center"><b>Search By Name</b></TD></tr><tr><td><input type="text" name="name" size=25 ></TD>
</td>
...
<b><i>All  Appointments</i></b>
  ...
  <th><b>MR</b><th><b>Name</b><th><b>Doctor</b><th><b>Clinic</b></th><th><b>Date</b></th><th><b>Time</b></th><th><b>Print Visit</b></th>
   ...
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       ...
       $lig = "<tr><td>" .
               $data[1]. "<td>".$data[2]. "<td>".$data[3]. "<td>".$data[4]. "<td>".$data[5]. "<td>".$data[6]. "<TD><a href=\"visithistoryform1.php?reservation1id=".$data[0]."&patientid=".$data[1]."\">Print Visit</a></TD>";
       echo $lig;
    }
    echo "</TABLE>";
  }
