  ...
  <tr>
    <td align="center">
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr> 
		<br><img border="0" src="images/jk.png" width="1300" height="140">
        ...
        <tr align="right"> 
		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="report31.php"><b>BACK</b></a></font></td>
			   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid1.php"><b>HOME</b></a></font></td>  
			   
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b> PATIENT INFORMATIONS</b>
                  </font></td>
...
<form action="formpatient11.php" method=POST>
<style type="text/css">
<!--
INPUT {
...
<tr>
<TD align="center"><b>PATIENT NAME</b></TD></tr><tr><td><input type="text" name="PATIENTNAME" size=30></TD></tr>
