		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="lab2.php"><b>BACK</b></a></font></td> 
			   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
				   ...
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>SEARCH ALL LAB TESTS REQUESTED FROM DOCTOR</b>
                </font></td>
...
<form  action="formlab5.php" id="formlab5" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">

<TABLE    align="center"  background="images/log2.jpg">
<tr>
  <TD colspan="6" align="center"><b>MR:*</b><input type="text" name="medicalnumber" size=10 onChange="controler(this)";></TD>
</tr></center>
...
<tr>
				...
				<A HREF="#" onClick="calendar.select(document.forms['formlab5'].fromdate,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
				</td>
				...
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['formlab5'].todate,'anchor2','yyyy-MM-dd');return false;" NAME="anchor2" ID="anchor2"><img src="images/insert_table.gif" border=0></A>
				</div>
				</td>
              </tr>
...
<td align="center" colspan="6">
 <input type="submit" name="bt_search" value="---- S E A R C H ----"></tr>
</table>
</form> 
