        ...
        <tr align="right"> 
          <td colspan="2" height="9"> 
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="40">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="editpatient.php"><b>BACK</b></a></font></td> 
																	    ...
																	    echo '<td>' . $row['patientstatus'] . '</td>'; 
																		 echo '<td>' . $row['patientbirthday'] . '</td>'; 
																		  echo '<td>' . $row['patientregistrationdate'] . '</td>';       
																			           ...
																			           echo '<td><a href="edit8.php?patientid=' . $row['patientid'] . '"><u>Edit</u></a></td>';          
																					                                                                                               echo "</tr>";         }       
												    // close table>       
													 echo "</table>";?><p><a href="patient.php">Add a new patient</a></p></body></html> 