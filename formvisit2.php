...
<?php
  ...
  echo "<th><b>OR</b></th><th><b>MR</b><th><b>PATIENT NAME</b></th><th><b>VISIT DATE</b></th><th><b>HISTORY</b></th><th><b>CHIEF COMPLAINT</b></th><th><b>PHYSICAL EXAM</b></th><th><b>DIAGNOSIS</b></th>";
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td>" .
              $data[0] . "<td>" . $data[1]. "<td>" . $data[2]. "<td>" . $data[3]. "<td>" . $data[4]. "<td>" . $data[5]. "<td>" . $data[6]. "<td>" . $data[7];
       echo $lig;
    }
    echo "</TABLE>";
  }
