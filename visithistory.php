            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid2.php"><b>BACK</b></a></font></td> 
			     <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="firstpage.php"><b>HOME</b></a></font></td>
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b> Search Engine</b>
                  </td>
        </tr>
        <tr align="center"> 
...
?>
        <tr valign="top"> 
          <td colspan="3" height="18"> 
                  ...
                  <div class="imagebox">
<form  action="visithistory.php" id="todayapp1" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
 <br><br><br><br>
<center><table background="images/log2.jpg">
<tr>
<TD align="center"><b>Search By Name</b></TD></tr><tr><td><input type="text" name="name" size=25 onChange="controler(this)";></TD>
</td>
...
<CAPTION>
<b><i>All  Appointments</i></b>
</CAPTION>
  <th><b>MR</b><th><b>Name</b><th><b>Doctor</b><th><b>Clinic</b></th><th><b>Date</b></th><th><b>Time</b></th><th><b>Print Visit</b></th>
   <?php
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td>" .
               $data[1]. "<td>".$data[2]. "<td>".$data[3]. "<td>".$data[4]. "<td>".$data[5]. "<td>".$data[6]. "<TD><a href=\"visithistoryform.php?reservation1id=".$data[0]."&patientid=".$data[1]."\">Print Visit</a></TD>";
       echo $lig;
    }
    echo "</TABLE>";
  }
