...
?>
        <tr valign="top"> 
          <td colspan="3" height="18"> 
                  ...
                  <div class="imagebox">
<form  action="todayapp3.php" id="todayapp1" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
 <br><br><br><br>
...
<tr><td colspan=2 align="center"><b> DOCTOR NAME:</b></td><TD><select name="doctorname" >
                 ...
                 <?php 
				 include"bdd.php";
                    $query = mysql_query("select doctorname  from doctor where doctor.username= '".$_SESSION["userid"]."' and doctor.password= '".$_SESSION["password"]."' ") 
                           or die(mysql_error());  
...
<td ><div align="left" style="float:left">
                    <input name="date"  align="center" type="text" size="15" class="input" value="<?php echo date("20y-m-d",time())?>" >
                </div>
...
<b><i>TODAY APPOINTMENTS</i></b>
  ...
  <th><b>MR</b><th><b>Name</b><th><b>Doctor</b><th><b>Clinic</b></th><th><b>Date</b></th><th><b>Time</b></th><th><b>Make Orders</b></th><th><b>Print Orders</b></th>
   <?php
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td>" .
               $data[1]. "<td>".$data[2]. "<td>".$data[3]. "<td>".$data[4]. "<td>".$data[5]. "<td>".$data[6]. "<TD><a href=\"order.php?reservation1id=".$data[0]."&patientid=".$data[1]."&doctorid=".$p[0]."\">Make Orders</a></TD><TD><a href=\"printorders.php?reservation1id=".$data[0]."\">Print Orders</a></TD>";
       echo $lig;
    }
    echo "</TABLE>";
  }
