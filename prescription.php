...
<table width="1300" border="0" bgcolor="#FFFFFF" align="center">
      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr align="right"> 
		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="medication.php"><b>BACK</b></a></font></td> 
 ...
 <form  action="formcherche.php" id="formcherche" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
<TABLE    align="center"  
...
<td>
				...
				<A HREF="#" onClick="calendar.select(document.forms['formcherche'].orderdate,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
