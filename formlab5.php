...
include"bdd.php";
{
$sql2 = "select laboratory.laboratoryid,patientfirstname,testname,orderdate from patient,laboratory where patient.patientid=laboratory.patientid and laboratory.patientid='".$_POST["medicalnumber"]."' and laboratory.orderdate between '".$_POST["fromdate"]."' and '".$_POST["todate"]."' ";
...
<?php
  ...
  echo "<th><b>OR</b></th><th><b>TEST NAME</b></th><th><b>ORDER DATE</b></th>";
