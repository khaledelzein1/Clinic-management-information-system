...
?>
        <tr valign="top"> 
          <td colspan="3" height="18"> 
                  ...
                  <div class="imagebox">
<form  action="todayapp2.php" id="todayapp1" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
 <br><br><br><br>
...
<b><i>TODAY APPOINTMENTS</i></b>
  ...
  <th><b>MR</b><th><b>Name</b><th><b>Doctor</b><th><b>Clinic</b></th><th><b>Date</b></th><th><b>Time</b></th><th><b>View Vital Signs</b></th><th><b>Start Visit</b></th>
   <?php
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td>" .
               $data[1]. "<td>".$data[2]. "<td>".$data[3]. "<td>".$data[4]. "<td>".$data[5]. "<td>".$data[6]. "<TD><a href=\"formvital1.php?reservation1id=".$data[0]."\">View Vital Signs</a></TD><TD><a href=\"medical1.php?reservation1id=".$data[0]."&patientid=".$data[1]."\">Start</a></TD>";
       echo $lig;
    }
    echo "</TABLE>";
  }
