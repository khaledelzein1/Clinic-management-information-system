		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="report2.php"><b>BACK</b></a></font></td> 
			   <td height=""><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
				   ...
				   <td height=""><font face="cooper black, Helvetica, sans-serif" size="3"><b>FIND ALL X_RAY REQUESTED FROM DOCTOR</b>
...
<form  action="formlab6.php" id="formlab6" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
...
<tr>
				...
				<A HREF="#" onClick="calendar.select(document.forms['formlab6'].fromdate,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
				</td>
				...
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['formlab6'].todate,'anchor2','yyyy-MM-dd');return false;" NAME="anchor2" ID="anchor2"><img src="images/insert_table.gif" border=0></A>
				</div>
				</td>
              </tr>
