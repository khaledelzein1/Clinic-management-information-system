...
{
var required=['medicalnumber','date'];
      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr align="right"> 
		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="sick.php"><b>BACK</b></a></font></td> 
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
			   
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>PRINT SICK LEAVE REPORT</b>
                 </font></td>
...
<form  action="printsick1.php" id="printsick1" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
<br><br>
...
<TD><b> DATE:*</b>
				...
				<div align="left" style="float:left">
                    <input name="date"  type="text" size="
					15" class="input" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['printsick1'].date,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
				</td></TD><tr>

<td colspan="6" align="center"><input type=submit size=30 name="btsearch" value="----S E R A C H----"></td></tr></tr>
</table>
