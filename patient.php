...
<body text="#000000" leftmargin="0" topmargin="0">
 ...
 <form  action="patient.php" id="patient" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
<style type="text/css">
<!--
.imagebox{width:100%;
height:300;
        ...
        <tr align="right"> 
          <td colspan="2" height="9"> 
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="34">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="findpatient.php"><b>BACK</b></a></font></td> 
			   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
			    <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"> <a href="editpatient.php"> <u> UPDATE </u></a></font></td> 
...
$sql="insert into clinic.patient (patientfirstname, patientadresse, patientphone,registernumber, patientsexe, patientnationality, patientstatus, patientbirthday, patientregistrationdate,doctorname) VALUES ('".$d2."','" .$d3."','" .$d4."','" .$d5."','" .$d6."','" .$d7."','" .$d8."','" .$d9."','" .$d10."','" .$d12."')";
mysql_query($sql);
