          ...
          <td colspan="3" height="9"> 
		   <form action="datagrid2.php" method="POST">
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="nurselogin.php"><b>BACK</b></a></font></td> 
			   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>Nurse Main Page</b></font></td> 
...
?>
		<div class="imagebox">
			<br> <br><br>
			 <table align="center" border="0" width="50%"  background="images\log2.jpg">
              <tr > 
			  
			   
			   
			   <td>
			   <form action="todayapp4.php" method="post""> 
