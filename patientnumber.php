      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr align="right"> 
		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="visit1.php"><b>BACK</b></a></font></td> 
			    <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
			   
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>NUMBER OF PATIENT'S VISITED CLINIC BETWEEN TWO DATE</b>
                 </font></td>
...
<form  action="numberpatient.php" id="numberpatient" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
...
<tr>
				...
				<div align="left" style="float:left">
                    <input name="FROMDATE"  type="text" size="
					15" class="input" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['numberpatient'].FROMDATE,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
				</td>
                ...
                <td >
				<div align="left" style="float:left">
                    <input name="TODATE" type="text" class="input"  size="15" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['numberpatient'].TODATE,'anchor2','yyyy-MM-dd');return false;" NAME="anchor2" ID="anchor2"><img src="images/insert_table.gif" border=0></A>
				</div>
				</td>
              </tr><tr><td colspan="6" align="center">
 <input type="submit" name="bt_search" value="---- S E A R C H ----"></td>
</tr>
</table>
</form> 
