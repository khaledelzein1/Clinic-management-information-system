		   ...
		   <form action="report3.php" method="POST">
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="registration1.php"><b>BACK</b></a></font></td> 
			   <td height=""><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid1.php"><b>HOME</b></a></font></td> 
			   
				   <td height=""><font face="cooper black, Helvetica, sans-serif" size="3"><b>PATIENTS STATISTICS</b>
                </font></td>
			</form>
          </td>
        </tr>
        ...
        <tr valign="top"> 
          <td colspan="3" height="18"> 
                  ...
                  <div class="imagebox"><br><br>
                         ...
                         <table align="center"  width="40%" background="images/log2.jpg">
              <tr > 
						 <td align="center">
						  <form action="bypatient11.php" method="post""> 
               <input type="submit" value=" PATIENT INFORMATIONS BY NAME" style="height:60" style="width:100%"/> 
               </form></tr><tr>
			   </td><td> <form action="bypatient22.php" method="post""> 
               <input type="submit" value=" PATIENT INFORMATIONS BY MR" style="height:60" style="width:100%"/> 
               </form>
