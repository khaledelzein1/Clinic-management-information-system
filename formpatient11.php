...
{
$a=$_POST["PATIENTNAME"];
$sql2 = "select patientid,patientfirstname,patientadresse,patientphone,patientbirthday from patient where patientfirstname like '%".$a."%'";
...
<?php
  ...
  echo "<th><b>MR</b><th><b>PATIENT  NAME</b></th><th><b>ADRESS</b></th><th><b>PHONE NUMBER</b></th><th><b>BIRTH DATE</b></th>";
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       ...
       $lig = "<tr><td>" .
              $data[0] . "<td>" . $data[1]. "<td><center>" . $data[2]. "<td><center>" . $data[3]. "<td>" . $data[4];
       echo $lig;
    }
    echo "</TABLE>";
  }
