...
echo "<tr><td><center><h2><br> <u>VISIT HISTORY REPORT</u></h2></center><center> </td></tr></table></center>";
...
<?php
  ...
  echo "<th><b>VISIT DATE</b></th><th><b>HISTORY</b></th><th><b>CHIEF COMPLAINT</b></th><th><b>PHYSICAL EXAM</b></th><th><b>diagnosis</b></th><th><b></b></th>";
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td><center>" .
               $data[2]. "<td>" . $data[3]. "<td>" . $data[4]. "<td>" . $data[5]. "<td>" . $data[6];
       echo $lig;
    }
    echo "</TABLE>";
  }
