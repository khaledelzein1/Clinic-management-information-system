      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr valign="top"> 
          <td colspan="3" height="18"> 
              ...
              <br><br><br>
<form action="formvital.php" method=POST>
<br>
<table  align="center"   
 background="images/log2.jpg">
<tr><TD align="center"><b>MEDICAL NUMBER</b></TD></tr><tr><td><input type="text" name="MEDICALNUMBER" size=25 onChange="controler(this)";></TD></tr>
<tr>
