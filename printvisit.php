...
<table width="1300" border="0" bgcolor="#FFFFFF" align="center">
      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr align="right"> 
		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="medical1.php"><b>BACK</b></a></font></td> 
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
			   
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>CHECK VISIT</b>
 ...
 <form  action="formvisit.php" id="formvisit" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
<style type="text/css">
<!--
INPUT {
...
{
var required=['medicalnumber','visitdate'];
...
<TD><b>MR:*</b></TD><td><input type="text" name="medicalnumber" size=10 onChange="controler(this)";></TD>
<TD><b>VISIT DATE:*</b></TD>
<td >
				<div align="left" style="float:left">
                    <input name="visitdate" size=15 type="text" class="input" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['formvisit'].visitdate,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
				</td><tr>
<td colspan="4" align="center"><input type=submit size=20 name="btsearch" value="----S E A R C H----"></td></tr></tr>
</table>
