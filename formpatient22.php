...
include"bdd.php";
{
$sql2 = "select patientid,patientfirstname,patientadresse,patientphone,patientbirthday from patient where patientid= '".$_POST["MEDICALNUMBER"]."'";
...
<?php
  ...
  echo "<th><b>MR</b><th><b>PATIENT  NAME</b></th><th><b>ADRESS</b></th><th><b>PHONE NUMBER</b></th><th><b>BIRTH DATE</b></th>";
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td><center>" .
              $data[0] . "<td><center>" . $data[1]. "<td><center>" . $data[2]. "<td><center>" . $data[3]. "<td><center>" . $data[4];
       echo $lig;
    }
    echo "</TABLE>";
  }
