        ...
        <tr align="right"> 
          <td colspan="2" height="9"> 
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="40">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="editlab.php"><b>BACK</b></a></font></td> 
...
<?php /*         VIEW.PHP        Displays all data from 'players' table*/        // connect to the database     
 include"bdd.php";       
  // get results from database   
       $result = mysql_query("select laboratory.laboratoryid,laboratory.patientid,laboratory.doctorname,laboratory.orderdate,laboratory.testname from laboratory where laboratory.patientid='".$_POST["medicalnumber"]."' and laboratory.orderdate = '".$_POST["orderdate"]."' ")   or die(mysql_error());       
	                      // display data in table       
						        
						             echo "<table border='1' bgcolor='white'  cellpadding='10'>";       
									  echo "<tr> <th>TRANS ID</th> <th>MR</th> <th>DOCTOR NAME</th><th>ORDER DATE</th><th>TEST NAME</th><th>EDIT </th><th>DELETE</th> </tr>";     
										          ...
										          echo "<tr>";      
												            echo '<td><center>' . $row['laboratoryid'] . '</td>';       
															         echo '<td>' . $row['patientid'] . '</td>';       
																			  ...
																			  echo '<td><center>' . $row['testname'] . '</td>';   
																			  
																			           echo '<td><a href="edit3.php?laboratoryid=' . $row['laboratoryid'] . '"><u>Edit</u></a></td>';          
																					         echo '<td><a href="delete3.php?laboratoryid=' . $row['laboratoryid'] . '"><u>Delete</u></a></td>';                                                                                      echo "</tr>";         }       
												    // close table>       
													 echo "</table>";?><p><a href="lab.php">Add a new orders</a></p></body></html> 