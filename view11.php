        ...
        <tr align="right"> 
          <td colspan="2" height="9"> 
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="40">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="editpass.php"><b>BACK</b></a></font></td> 
			   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
			   
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>UPDATE PASSWORD</b>
                   </font></td>
...
<?php /*         VIEW.PHP        Displays all data from 'players' table*/        // connect to the database     
 include"bdd.php";       
  // get results from database   
       $result = mysql_query("select  signupid,userid, password, email from plus_signup where email='".$_POST["email"]."'")   or die(mysql_error());       
	                      // display data in table       
						        
						             echo "<table  bgcolor='white' border='1' cellpadding='10'>";       
									  echo "<tr><th>ID</th><th>USER ID</th><th>PASSWORD</th> <th>E_MAIL</th><th>EDIT </th><th>DELETE</th> </tr>";     
												   ...
												   echo '<td>' . $row['signupid'] . '</td>';      
												            echo '<td>' . $row['userid'] . '</td>';       
																			  ...
																			  echo '<td><center>' . $row['email'] . '</td>';   
																			           ...
																			           echo '<td><a href="edit11.php?signupid=' . $row['signupid'] . '"><u>Edit</u></a></td>';          
																					         echo '<td><a href="delete11.php?signupid=' . $row['signupid'] . '"><u>Delete</u></a></td>';                                                                                      echo "</tr>";         }       
												    // close table>       
													 echo "</table>";?><p><a href="signup.php">Add a new user</a></p></body></html> 