            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="report1.php"><b>BACK</b></a></font></td> 
			   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid1.php"><b>HOME</b></a></font></td> 
				   ...
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b> NUMBER OF APPOINTMETNS BY DATE</b>
                  </font></td>
...
<form  action="bydate.php" id="bydate" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
<br><br>
<center><table    background="images/log2.jpg">
<tr><td colspan=6 align="center"><b>SELECT DATE </b></td></tr>
 <td  ><b>FROM DATE :</b> </td>
                <td >
				<div align="left" style="float:left">
                    <input name="fromdate" size=15 type="text" class="input" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['bydate'].fromdate,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
				</td>
                ...
                <td >
				<div align="left" style="float:left">
                    <input name="todate" size=15 type="text" class="input" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['bydate'].todate,'anchor2','yyyy-MM-dd');return false;" NAME="anchor2" ID="anchor2"><img src="images/insert_table.gif" border=0></A>
				</div>
				</td>
</tr>
...
$sql2 = "select reservation1.reservation1id,patient.patientid,patientfirstname,doctor.doctorname,reservation1.reservationdate,reservation1.reservationtime,reservation1.getdate from doctor,patient,reservation1 where reservation1.doctorid=doctor.doctorid and patient.patientid=reservation1.patientid   and reservation1.getdate between '".$_POST["fromdate"]."' and '".$_POST["todate"]."' order by reservation1.getdate  " ;

$res = mysql_query($sql2);
  if (mysql_num_rows($res)==0)
       echo "<br> NO APPOINTMENTS IN THIS DATE ";

  else { ?>
  
<br>
     <TABLE BORDER align="center" background="images/log2.jpg">
<CAPTION><b><i>APPOINTMENTs DATE</i></b></CAPTION>
 <th><b>MR</b><th><b>PATIENT NAME</b><th><b>DOCTOR NAME</b><th><b>RESERVATION DATE</b></th><th><b>RESERVATION TIME</b></th><th><b>REPORT DATE</b></th>
   <?php
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td><center>" .
               $data[1]. "<td><center>".$data[2]. "<td><center>".$data[3]. "<td><center>".$data[4]. "<td><center>".$data[5]. "<td><center>".$data[6];
       echo $lig;
    }
    echo "</TABLE>";
  }
