...
<table width="1300" border="0" bgcolor="#FFFFFF" align="center">
  <tr>
    <td align="center">
	  ...
	  <br>
        <tr> 
		<img border="0" src="images/jk.png" width="1340" height="130">
          
        </tr>
        <tr align="right"> 
          <td colspan="2" height="9"> 
		   <form action="bydate.php" method="POST">
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="35">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>BACK</b></a></font></td> 
			   <td height="35"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
			   
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b> SECURITY</b>
                  </font></td>
				   </tr>
            </table>
			</form>
...
<TD><INPUT TYPE=text NAME=pass SIZE=30  value="<?php echo $d3;?>"></TD>
</table>
...
<?php
include"bdd.php";
$sql = "select * from security order by securityid";
  $res = mysql_query($sql);
  ?>
<table align=center bgcolor="#00CCFF" border=1>
<caption align=center bgcolor="#B87060"></caption><th>SELECT</th><th> USER NAME</th><th>PASSWORD</th>
 <?php
 ...
 $bgcolor="#00CCFF";
  $data = mysql_fetch_row($res);
  $lig="<TR bgcolor=".$bgcolor."><TD><center><a href=\"updatepassword.php?securityid=".$data[0]."\">".$data[0]."</a></TD><TD><center>".$data[1]."</TD><TD><center>".$data[2]."</TD></tr>";
  echo $lig;
    }
       ?>
</table>
