...
include"bdd.php";
{
$sql2 = "select patient.patientid,patientfirstname,medication.doctorname,medication.orderdate,medication.medicationname,medication.prescription from medication,patient where patient.patientid=medication.patientid  and medication.patientid='".$_POST["medicalnumber"]."'";
...
<?php
  ...
  echo "<th><b>ORDER DATE</b></th><th><b>MEDICATION NAME</b></th><th><b>PRESCRIPTION</b></th>";
