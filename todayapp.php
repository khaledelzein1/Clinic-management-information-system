            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="appointment1.php"><b>BACK</b></a></font></td> 
			     <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid1.php"><b>HOME</b></a></font></td>
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b> TODAY APPOINTMENT</b>
                    </font></td>
			</form>
          </td>
        </tr>
...
<form  action="todayapp.php" id="todayapp" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
 
<center><table     background="images/log2.jpg">
<tr><td colspan=2 align="center"><b>SELECT DATE  </b></td></tr><tr>
 <td  >
				<div align="left" style="float:left">
                    <input name="txtsearch"  align="center" type="text" size="25" class="input" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['todayapp'].txtsearch,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
				</td></tr>
<tr>
<td colspan="3" align="center"><input type=submit size=30 name="btsearch" value="S E A R C H"></td></tr></tr>
</table>
<?php
include"bdd.php";
if(isset($_POST["btsearch"])){
 $a=$_POST["txtsearch"];
$sql2 = "select reservation1.reservation1id,patient.patientid,patientfirstname,doctor.doctorname,newclinic.clinicname,reservation1.reservationdate,reservation1.reservationtime from doctor,newclinic,patient,reservation1 where reservation1.doctorid=doctor.doctorid and reservation1.clinicid=newclinic.clinicid and patient.patientid=reservation1.patientid and reservation1.reservationdate='".$_POST["txtsearch"]."' order by reservation1.patientid";
...
<b><i>TODAY APPOINTMENTS</i></b>
 ...
 <th><b>MR</b><th><b>Name</b><th><b>Doctor</b><th><b>Clinic </b></th><th><b>App Date</b></th><th><b>App Time</b></th>
   <?php
