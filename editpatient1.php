    ...
    <td align="center">
	  ...
	  <br>
        ...
        <tr align="right"> 
		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="31">
              <tr align="center" bgcolor="#98AFC7">
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="patient1.php"><b>BACK</b></a></font></td> 
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid1.php"><b>HOME</b></a></font></td> 
			   
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>UPDATE PATIENT INFORMATIONS</b>
                  </font></td>
        ...
        <tr >
          <td colspan="4" height="10">
				...
				<div class="imagebox">
               <br><br><br>
<form action="view88.php" method=POST>
<br><br>
<table  align="center"     background="images/log2.jpg"><tr>
<TD align="center"><b>MEDICAL NUMBER</b></TD></tr><tr><td><input type="text" name="medicalnumber" size=25 onChange="controler(this)";></TD>
<tr>
</td></tr>
<td colspan="2" align="center"><input type=submit size=30 name="btsearch" value="----S E A R C H----"></td></tr></tr>
</table>
