...
echo "<tr><td><center><h2><br> <u>LABORATORY RESULT'S REPORT</u></h2></center><center> </td></tr></table></center>";
...
echo "<tr><td><b>Patient Name :</b> ". $row['patientfirstname'] ."</td></tr></table>";
  ...
  if (mysql_num_rows($res)==0)
      echo"<script>alert(\" ATTENTION: NO RESULTS FOUND FOR THIS PATIENT \")</script>";
...
<?php
  ...
  echo "<th><b>OR</b></th><th><b>TEST NAME</b></th><th><b>TEST RESULT</b></th><th><b>DOCTOR NOTES</b></th><th><b>ORDER DATE</b></th><th><b>RESULT DATE</b></th>";
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td><center>" .
              $data[0]. "<td><center>" . $data[4]. "<td><center>" . $data[5]. "<td><center>" . $data[6]. "<td><center>" . $data[7]. "<td><center>" . $data[8];
       echo $lig;
    }
    echo "</TABLE>";
  }
