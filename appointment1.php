      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
          ...
          <td colspan="2" height="9"> 
		   <form action="datagrid.php" method="POST">
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid1.php"><b>BACK</b></a></font></td> 
        ...
        <tr valign="top"> 
          <td colspan="4" height="18"><div class="imagebox"> <br><br>
                        ...
                        <table width="40%"  align="center"  background="images/log2.jpg" cellpadding="0" cellspacing="2">
						 <tr> <td>
						  <form action="reservation1.php" method="post""> 
               <input type="submit" value="RESERVATION" style="height:60" style="width:100%"/> 
               </form>
			   </td>
			   <td align="center">
			   <form action="todayapp.php" method="post""> 
               <input type="submit" value="TODAY APPOINTMENT
 BY DATE" style="height:60" style="width:100%"/> 
               </form>
			   </td></tr><tr><td align="center">
			    <form action="todayapp1.php" method="post"> 
               <input  type="submit" value="TODAY APPOINTMENT
BY DOCTOR NAME" style="height:60" style="width:100%"/> 
               </form>
			   </td>
			   <td align="center">
			   <form action="report1.php" method="post""> 
               <input type="submit" value="REPORTS" style="height:60" style="width:100%"/> 
               </form>
