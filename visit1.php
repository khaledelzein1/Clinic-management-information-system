...
<table width="1300" border="0" bgcolor="#FFFFFF" align="center">
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>BACK</b></a></font></td> 
			   <td height=""><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
				   ...
				   <td height=""><font face="cooper black, Helvetica, sans-serif" size="3"><b>REPORTS & STATISTICS</b>
                   </font></td>
 ...
 background="images/log2.jpg">
              <tr > 
						 <td align="center">
						  <form action="hist3.php" method="post""> 
               <input type="submit" value="PATIENT'S HISTORY" style="height:60" style="width:100%"/> 
               </form>
			   </td><td> <form action="visithistory1.php" method="post""> 
               <input type="submit" value="VISIT HISTORY" style="height:60" style="width:100%"/> 
               </form>
			   </td><td align="center">
						  <form action="patientnumber.php" method="post""> 
               <input type="submit" value="PATIENT'S NUMBER" style="height:60" style="width:100%"/> 
               </form>
			   </td></tr><tr><td> <form action="stat2.php" method="post""> 
               <input type="submit" value=" STATISTICS BY DATE" style="height:60" style="width:100%"/> 
               </form> 
			    </td><td align="center">
						  <form action="formlast.php" method="post""> 
               <input type="submit" value="VIEW LAST VISIT'S" style="height:60" style="width:100%"/> 
               </form>
