      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr align="right"> 
		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
				   ...
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>VITAL SIGNS REPORTS</b>
                 </font></td>
        ...
        <tr valign="top"> 
          <td colspan="3" height="18"> 
                  ...
                  <div class="imagebox">
              <br><br><br>
<form action="formvital1.php" method=POST>
<br>
<table   align="center"  background="images/log2.jpg">
<tr><TD align="center"><b>TRANSACTION ID</b></TD></tr><tr><td><input type="text" name="TRANSACTIONID" size=25 onChange="controler(this)";></TD>
<tr>
