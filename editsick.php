...
<table width="1300" border="0" bgcolor="#FFFFFF" align="center">
 ...
 <form  action="view9.php" id="view9" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
...
<TD><b>SICK LEAVE DATE:*</b></TD><td>
				<div align="left" style="float:left">
                    <input name="orderdate" size=15 type="text" class="input" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['view9'].orderdate,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
</td></tr>
