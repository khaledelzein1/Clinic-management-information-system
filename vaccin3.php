		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="immunization.php"><b>BACK</b></a></font></td> 
			    <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td>
				   ...
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>CHECK VISIT BY DATE</b>
                 </font></td>
...
<form  action="vaccin4.php" id="vaccin4" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
...
<TD><b>ORDER DATE:*</b><td>
				...
				<A HREF="#" onClick="calendar.select(document.forms['vaccin4'].orderdate,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
