...
exit;
 ...
 <center><h2><u><font color="red"> NUMBER OF PATIENT'S VISITED CLINIC</u></h2></center>
  <center><h2><u><font color="red">CALCULATED BY DAY</u></h2></center>
...
$sql2 = "select count(patientid),patientregistrationdate from patient where patientregistrationdate between '".$_POST["FROMDATE"]."'and '".$_POST["TODATE"]."' group by patientregistrationdate"; 
...
<?php
  ...
  echo "<th><b> NUMBER OF PATIENT'S</b><th><b>DATE</b></th>";
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td><center>" .
              $data[0] . "<td><center>" . $data[1];
       echo $lig;
    }
    echo "</TABLE>";
  }
...
while($row = mysql_fetch_array($result)){
	echo "<center>TOTAL = ". $row['count(patientid)'] ." PATIENTS.";
	echo "<br />";
}
?>
<?php
