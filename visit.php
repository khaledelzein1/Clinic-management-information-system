      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr valign="top"> 
          <td colspan="3" height="18"> 
                  ...
                  <div class="imagebox"><br><br>
            
                 <center> 
               <table align="center" bgcolor="#98AFC7" width="40%"   background="images/log2.jpg">
						<tr>
						<td align="center">
						  <form action="vital.php" method="post""> 
               <input type="submit" value="VITAL SIGNS" style="height:60" style="width:100%"/> 
               </form>
			   </td><td> <form action="visit2.php" method="post""> 
               <input type="submit" value="MEDICAL VISITS" style="height:60" style="width:100%"/> 
               </form>
			   </td></tr><tr><td align="center">
						  <form action="vital1.php" method="post""> 
               <input type="submit" value="VITAL SIGNS REPORTS" style="height:60" style="width:100%"/> 
               </form>
			   </td><td> <form action="vital2.php" method="post""> 
               <input type="submit" value=" VITAL SIGNS TRANSACTIONS" style="height:60" style="width:100%"/> 
               </form>
			   </td></tr><tr>
			   <td align="center">
						  <form action="viewvisit.php" method="post""> 
               <input type="submit" value="VIEW ALL VISITS FOR PATIENT" style="height:60" style="width:100%"/> 
               </form>
			   </td><td> <form action="viewvisit1.php" method="post""> 
               <input type="submit" value=" VIEW VISIT BY ORDER NUMBER" style="height:60" style="width:100%"/> 
               </form>
			   </td></tr>
