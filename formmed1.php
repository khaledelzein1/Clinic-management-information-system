...
include"bdd.php";
{
$sql2 = "select patient.patientid,patientfirstname,medication.doctorname,medication.orderdate,medication.medicationname,medication.prescription from medication,patient where patient.patientid=medication.patientid and  patient.patientid='".$_POST["medicalnumber"]."' and medication.orderdate between '".$_POST["fromdate"]."' and '".$_POST["todate"]."' ";
...
echo "<tr><td><center><h2><br> <u> MEDICATION REPORT</u></h2></center><center> </td></tr></table></center>";
...
<?php
  ...
  echo "</th><th><b>ORDER DATE</b></th><th><b>MEDICATION NAME</b></th><th><b>PRESCRIPTION</b></th>";
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td>" .
               $data[3]. "<td>" . $data[4]. "<td>" . $data[5];
       echo $lig;
    }
    echo "</TABLE>";
  }
