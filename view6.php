        ...
        <tr align="right"> 
          <td colspan="2" height="9"> 
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="40">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="editxrayres.php"><b>BACK</b></a></font></td> 
...
<?php /*         VIEW.PHP        Displays all data from 'players' table*/        // connect to the database     
 include"bdd.php";       
  // get results from database   
       $result = mysql_query("select xrayresult.xrayresultid,xrayresult.xrayid,xrayresult.resultdate,xrayresult.resultxray,xrayresult.drnote from xrayresult where xrayresult.xrayid='".$_POST["ordernumber"]."' and xrayresult.resultdate = '".$_POST["orderdate"]."' ")   or die(mysql_error());       
	                      // display data in table       
						        
						             echo "<table border='1' bgcolor='white' cellpadding='10'>";       
									  echo "<tr><th>X_RAY ID</th> <th> RESULT DATE</th> <th>X_RAY RESULT</th><th>DOCTOR NOTES</th><th>EDIT </th><th>DELETE</th> </tr>";     
										          ...
										          echo "<tr>";      
															 ...
															 echo '<td><center>' . $row['xrayid'] . '</td>';     
															         echo '<td>' . $row['resultdate'] . '</td>';       
																	          echo '<td><center>' . $row['resultxray'] . '</td>';       
																			  echo '<td><center>' . $row['drnote'] . '</td>';   
																			   
																			  
																			           echo '<td><a href="edit6.php?xrayresultid=' . $row['xrayresultid'] . '"><u>Edit</u></a></td>';          
																					         echo '<td><a href="delete6.php?xrayresultid=' . $row['xrayresultid'] . '"><u>Delete</u></a></td>';                                                                                      echo "</tr>";         }       
												    // close table>       
													 echo "</table>";?><p><a href="xray2.php">Add a new results</a></p></body></html> 