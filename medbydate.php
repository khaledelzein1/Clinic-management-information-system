  ...
  <tr>
    <td align="center">
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr> <br>
		<img border="0" src="images/med.jpg" width="1300" height="150">
...
<form  action="formmed1.php" id="medbydate" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
<TABLE  align="center"  
...
<TD colspan="6" align="center"><b>MEDICAL NUMBER:*</b><input type="text"  name="medicalnumber" size=10 onChange="controler(this)";></TD></tr>
			  <tr>
				...
				<div align="left" style="float:left">
                    <input name="fromdate"  type="text" class="input" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['medbydate'].fromdate,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
				</td>
                ...
                <td style="WIDTH: 274px" >
				<div align="left" style="float:left">
                    <input name="todate" type="text" class="input" >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['medbydate'].todate,'anchor2','yyyy-MM-dd');return false;" NAME="anchor2" ID="anchor2"><img src="images/insert_table.gif" border=0></A>
				</div>
				</td>
              </tr>
