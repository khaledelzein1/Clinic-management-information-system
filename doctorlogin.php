            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
              <tr align="center" bgcolor="#98AFC7"> 
			   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="4"><a href="firstpage.php"><b>Back</b>
			    <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>Doctor Log In</b></font></td> 
                  </font></td>
...
<table align="center" >
  ...
  <tr id='cat'>
  <tr><td colspan="4"><center><b>Doctor Login</b></center></td></tr>
...
<tr> <td colspan="3" align='center'><font face='verdana, arial, helvetica' size='2' align='center'>  
<a href="changepassdoctor.php">Forget Password</a>
</font></td> </tr>
...
$p=$_POST["password"];
$password=md5($p);
  $sql = "select * from doctor where username='".$u."' and password='".$p."' and usertypeid='2';";
