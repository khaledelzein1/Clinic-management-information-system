	...
	<img border="0" src="images/jk.png" width="1300" height="140">
        ...
        <tr align="right"> 
		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="referal.php"><b>BACK</b></a></font></td> 
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
			   
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>PRINT  REFERRAL TO HOSPITAL REPORT</b>
                  </font></td>
...
<form  action="printreferal1.php" id="printreferal1" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
<br><br>
<table   align="center"  
 background="images/log2.jpg">
<TD><b>MEDICAL NUMBER:*</b><input type="text" name="medicalnumber" size=10 onChange="controler(this)";></TD>
<TD><b>DATE:*</b></TD>
<td  >
				<div align="left" style="float:left">
                    <input name="date"  type="text" size="15" class="input"  >
                </div>
				<div style="float:left">
				<A HREF="#" onClick="calendar.select(document.forms['printreferal1'].date,'anchor1','yyyy-MM-dd');return false;" NAME="anchor1" ID="anchor1"><img src="images/insert_table.gif" border=0 ></A>
				</div>
				</td>
<tr>
</td></tr>
