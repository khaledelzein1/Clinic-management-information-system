...
<table width="1300" border="0" bgcolor="#FFFFFF" align="center">
		   ...
		   <form>
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid2.php"><b>BACK</b></a></font></td>
			   <td ><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid2.php"><b>HOME</b></a></font></td>  
			  <td ><font face="cooper black, Helvetica, sans-serif" size="3"><b>IMMUNIZATION RECORD</b>
 ...
 <br>
                        ...
                        <center><table width="50%" border="0"  background="images/log2.jpg">
						 <tr>
						  <td align="center">
						  <form action="immunization1.php" method="post""> 
               <input type="submit" value="IMMUNIZATION RECORD" style="height:60" style="width:100%"/> 
               </form>
			   </td></tr><tr>
			   <td colspan="2"> <form action="vaccin1.php" method="post""> 
               <input type="submit" value="CHECK ALL VACCINATIONS FOR PATIENT" style="height:60" style="width:100%"/> 
               </form>
			   </td></tr> 
			   
			   <tr> <td colspan="2"> <form action="national.php" method="post""> 
               <input type="submit" value="NATIONAL IMMUNIZATION SCHEDUALE" style="height:60" style="width:100%"/> 
               </form>
			   </td></tr> 
