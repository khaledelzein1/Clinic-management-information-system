      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <tr align="right"> 
		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="reservation1.php"><b>BACK</b></a></font></td> 
        ...
        <tr valign="top"> 
          <td colspan="3" height="18"> 
				  ...
				  <form  action="slipap1.php" id="slipap" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
