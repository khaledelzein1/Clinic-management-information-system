		  ...
		  <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="report2.php"><b>BACK</b></a></font></td> 
			   <td height=""><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid.php"><b>HOME</b></a></font></td> 
				   ...
				   <td height=""><font face="cooper black, Helvetica, sans-serif" size="3"><b>FIND X_RAY RESULT FOR PATIENT</b>
        ...
        <tr valign="top"> 
          <td colspan="3" height="18"> 
            ...
            <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
              <br><br><br>
<form action="formorder.php" method=POST>
<TABLE   align="center"  
 background="images/log2.jpg">
<tr>
<TD align="center"><b>ORDER NUMBER</b></TD></tr><tr><td><input type="text" name="ordernumber" size=25 onChange="controler(this)";></TD><tr><td align="center" colspan="2">
