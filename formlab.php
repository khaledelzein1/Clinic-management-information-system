...
$sql2 = "select laboratoryid,laboratory.testname from laboratory where laboratory.patientid='".$_POST["medicalnumber"]."' and laboratory.orderdate= '".$_POST["orderdate"]."'";
...
echo "<center><table  width=56%><tr><td> Medical Number : ". $row['patientid'] ."</td>";
...
<?php
  ...
  echo "<th><b> ORDER NUMBER</b><th><b>TEST NAME</b></th>";
