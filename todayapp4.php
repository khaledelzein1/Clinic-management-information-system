        ...
        <tr align="right"> 
          <td colspan="2" height="9"> 
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="20">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid3.php"><b>BACK</b></a></font></td> 
			     <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="firstpage.php"><b>HOME</b></a></font></td>
				   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>  APPOINTMENT </b>
                  </td>
        </tr>
        <tr align="center"> 
...
?>
        <tr valign="top"> 
          <td colspan="3" height="18"> 
                  ...
                  <div class="imagebox">
<form  action="todayapp4.php" id="todayapp1" method="post" enctype="multipart/form-data" name="RTEDemo" onSubmit="submitForm();">
 <br><br><br><br>
<center><table     background="images/log2.jpg">
<tr></td><td colspan=2 align="center"><b>SELECT DATE :</b>
...
<b><i>TODAY APPOINTMENTS</i></b>
  ...
  <th><b>MR</b><th><b>Name</b><th><b>Doctor</b><th><b>Clinic</b></th><th><b>Date</b></th><th><b>Time</b></th><th><b>Click</b></th>
   <?php
   for ($n=0;$n<mysql_num_rows($res);$n++) {
       $lig = "<tr>";
       $data = mysql_fetch_row($res);
       $lig = "<tr><td>" .
               $data[1]. "<td>".$data[2]. "<td>".$data[3]. "<td>".$data[4]. "<td>".$data[5]. "<td>".$data[6]. "<TD><a href=\"vital.php?reservation1id=".$data[0]."&patientid=".$data[1]."\">Vital Signs</a></TD>";
       echo $lig;
    }
    echo "</TABLE>";
  }
