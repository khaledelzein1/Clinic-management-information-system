      ...
      <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		   ...
		   <form action="datagrid.php" method="POST">
            <table  align="center" width="100%" border="0" cellpadding="0" cellspacing="3" height="40">
			  ...
			  <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><a href="datagrid1.php"><b>BACK</b></a></font></td> 
			   ...
			   <td height="22"><font face="cooper black, Helvetica, sans-serif" size="3"><b>PATIENT REGISTRATION </b></font></td>
        ...
        <tr valign="top"> 
          <td colspan="3" height="18"> 
                  ...
                  <div class="imagebox">
				  <br><br><br><br>
                        <table align="center" background="images\log2.jpg" width="50%" border="0" >
						<tr>
						<td align="center">
			   <form action="findpatient1.php" method="post""> 
               <input type="submit" value="PATIENT REGISTRATION" style="height:60" style="width:100%"/> 
               </form>
			   </td>
			   </tr><tr>
			    <td align="center">
			   <form action="monitor1.php" method="post""> 
               <input type="submit" value="PATIENT'S MONITOR" style="height:60" style="width:100%"/> 
               </form>
			   </td>
			   </tr>
